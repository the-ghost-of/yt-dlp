...
class ABCIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if mobj is None:
            ...
            youtube = mobj['type'] == 'YouTube'
            video = mobj['type'] == 'Video' or urls_info[0]['contentType'] == 'video/mp4'
